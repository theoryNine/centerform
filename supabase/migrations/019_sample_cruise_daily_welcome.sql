...
-- All timestamps UTC. Miami is ET = UTC-5 in November.
-- Morning updates: 8:00am ET = 13:00 UTC
-- Evening updates: 6:00pm ET = 23:00 UTC
-- Each entry expires when the next one begins; the final entry expires at
-- midnight ET on disembarkation day (05:00 UTC Nov 19).

INSERT INTO cruise_daily_welcome (venue_id, effective_at, expires_at, heading, body) VALUES

-- SAT NOV 11 — Embarkation (evening, after sail-away)
(
...
-- WED NOV 15 — Grand Cayman (morning)
(
  'c2b3d4e5-0000-4000-a000-000000000001',
  '2025-11-15 13:00:00+00',
...
-- WED NOV 15 — Scarlet Night (evening)
(
  'c2b3d4e5-0000-4000-a000-000000000001',
  '2025-11-15 23:00:00+00',
